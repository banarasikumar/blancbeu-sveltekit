...
fetch('https://api.github.com/repos/banarasikumar/blancbeu-sveltekit/actions/runs?per_page=1')
	...
	.then((data) => {
		...
		return fetch(
			`https://api.github.com/repos/banarasikumar/blancbeu-sveltekit/actions/runs/${runId}/jobs`
		);
	})
	.then((res) => res.json())
	.then((jobs) => {
		...
		return fetch(
			`https://api.github.com/repos/banarasikumar/blancbeu-sveltekit/actions/jobs/${jobId}/logs`
		);
	})
	.then((res) => res.text())
	.then((text) => {
