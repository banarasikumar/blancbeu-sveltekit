...
export async function requestUserNotificationPermission(
	...
	if (Notification.permission === 'denied') {
		...
		return {
			success: false,
			error: 'Permission previously denied by user',
	...
	try {
		...
		console.log(
			'[UserNotifications] VAPID key available (first 10 chars):',
		...
		console.log(
			'[UserNotifications] FCM token obtained (first 20 chars):',
