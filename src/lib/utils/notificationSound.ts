...
import {
	...
	type SoundType as AdminSoundType,
	AVAILABLE_SOUNDS as ADMIN_AVAILABLE_SOUNDS
} from '$lib/stores/adminNotifications';
...
export async function playSelectedNotificationSound(volume = 0.7): Promise<void> {
	return playAppNotificationSound(soundEnabled, selectedSoundType, AVAILABLE_SOUNDS, volume);
}
